...
```groovy
dependencies {
  implementation 'com.braintreepayments.api:samsung-pay:2.1.0'
}
```
...
* [Read the docs](https://developer.paypal.com/braintree/docs/guides/samsung-pay/client-side/android/v4)
